...
function UpdateInvoice({ invoice }) {
	...
	const formik = useFormik({
		initialValues: {
			...
			billDate: invoice.billDate || dayjs().toString(),
			dueDate: invoice.dueDate || dayjs().toString(),
	...
	const handleBillDate = value => {
		formik.setFieldValue('billDate', value ? value.toString() : '')
	}
					...
					<div className='grid grid-cols-1 md:grid-cols-2 gap-2'>
						...
						<div className='flex flex-col'>
							...
							<DatePicker
								...
								allowClear={false}
								id='billDate'
								onChange={value => handleBillDate(value)}
